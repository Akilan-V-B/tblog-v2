...
export const Profile = () => {
    ...
    const fetchTblog = async () => {
        try {
            const response = await axios.post("http://127.0.0.1:5000/tblogs/yourblogs", { userOwner: userID })
    ...
    const fetchUser = async () => {
        try {
            const response = await axios.post("http://127.0.0.1:5000/auth/details", { _id: userID })
    ...
    try {
        console.log(id);
        const response = await axios.post(`http://127.0.0.1:5000/tblogs/deleteblog`,{blogId : id});
        await fetchTblog();
